...
ggplot(sw_berm, aes(x=DIC,y=Salinity)) + ggtitle("Salinity v.s DIC in BERM") + 
  geom_hex(bins=20, color = "white") + scale_fill_gradient(low = "lightblue", high = "blue")

ggplot(sw_bats, aes(x=DIC,y=Salinity)) + ggtitle("Salinity v.s DIC in BATS") + 
  geom_hex(bins=20, color = "white") + scale_fill_gradient(low = "lightblue", high = "blue")

ggplot(sw_hawi, aes(x=DIC,y=Salinity)) + ggtitle("Salinity v.s DIC in HAWI") + 
  geom_hex(bins=20, color = "white") + scale_fill_gradient(low = "lightblue", high = "blue")
```
